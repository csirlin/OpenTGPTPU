...
accum_raddr_sig, ub_act_waddr, act_out, ub_act_we, act_busy, start_addr_wv, act_cond, act_branch_enable, act_top_left, N_wv, act_func, pc_incr, pc_diff_high, pc_diff_low = act_top(pc=pc, acc_mems=acc_mems, start=dispatch_act, start_addr=accum_raddr, dest_addr=ub_dest_addr, nvecs=act_length, func=act_type, accum_out=acc_out, matsize=MATSIZE)
